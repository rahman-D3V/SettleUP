...
import Link from "next/link";
import { ArrowRight, CheckCircle, Star, Zap, Globe, Shield, Sparkles, Users, TrendingUp, Clock, DollarSign, Heart, Award, MessageSquare, BarChart3, Calendar, Smartphone } from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
...
const ADVANCED_FEATURES = [
  {
    ...
    description: "Automatically extract expense details from photos using AI-powered OCR technology.",
    icon: Smartphone,
    gradient: "from-blue-500 to-cyan-400"
  },
  {
    title: "Multi-Currency Support",
    description: "Handle expenses in any currency with real-time exchange rate conversion.",
    icon: Globe,
  ...
  },
  {
    ...
    description: "Set up monthly subscriptions and recurring bills to split automatically.",
    icon: Calendar,
...
const FAQ_DATA = [
  {
    ...
    answer: "We use bank-level encryption (AES-256) for all data transmission and storage. We never store your banking credentials and follow strict privacy policies. Your financial data is completely secure with us."
  },
  {
    question: "Can I use Splitr without an internet connection?",
    answer: "Yes! You can add expenses and view your data offline. All changes will automatically sync when you reconnect to the internet, ensuring you never lose any information."
  },
  {
    question: "What payment methods does Splitr support?",
    answer: "Splitr integrates with major payment platforms including PayPal, Venmo, bank transfers, Apple Pay, Google Pay, and Stripe. You can settle debts directly through the app using your preferred method."
  },
  {
    question: "Is there a limit to the number of expenses I can track?",
    answer: "No limits! All plans include unlimited expense tracking. Whether you're splitting a coffee bill or managing a month-long trip with friends, Splitr scales with your needs."
  },
  {
    question: "How accurate is the receipt scanning feature?",
    answer: "Our AI-powered receipt scanning has 95%+ accuracy rate. It can extract amounts, dates, merchant names, and even individual items from receipts. You can always review and edit the extracted data before saving."
  },
  {
    question: "Can I export my expense data?",
    answer: "Yes! Pro and Teams users can export their data to Excel, PDF, or CSV formats. This is perfect for tax purposes, reimbursements, or keeping personal records."
  }
];
...
export default function LandingPage() {
      ...
      <section className="relative mt-20 pb-20 space-y-16 px-5">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center space-y-10">
          ...
          <div className="animate-in fade-in slide-in-from-top duration-1000">
            <Badge variant="outline" className="bg-gradient-to-r from-emerald-50 to-blue-50 text-emerald-700 border-emerald-200 hover:shadow-lg transition-all duration-300 px-4 py-2">
          ...
          <div className="animate-in fade-in slide-in-from-bottom duration-1000 delay-200">
            <h1 className="mx-auto max-w-7xl text-5xl font-black md:text-7xl lg:text-8xl leading-tight tracking-tight">
              The <span className="relative inline-block">
                ...
                <div className="absolute -bottom-3 left-0 right-0 h-4 bg-gradient-to-r from-emerald-400/50 to-blue-400/50 -rotate-1 rounded-lg"></div>
              </span> way to 
              <br />
          ...
          <div className="animate-in fade-in slide-in-from-bottom duration-1000 delay-400">
            <p className="mx-auto max-w-[800px] text-xl text-slate-600 leading-relaxed md:text-2xl/relaxed">
              Track shared expenses, split bills effortlessly, and settle up instantly. 
              Join <span className="font-bold text-emerald-600">50,000+ users</span> who never worry about money between friends again.
            </p>
          </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom duration-1000 delay-600">
            ...
            <p className="mt-4 text-sm text-slate-500">
              ✨ No credit card required • ⚡ Setup in 30 seconds • 🔒 Bank-level security
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-sm text-slate-600 mt-16 p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-lg">
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-blue-500 border-3 border-white shadow-lg flex items-center justify-center text-white font-bold text-sm">
                      {String.fromCharCode(64 + i)}
                    </div>
                  ))}
                </div>
                <span className="font-semibold text-slate-700">
                  Trusted by <span className="text-emerald-600">50,000+</span> users worldwide
                </span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-700">4.9/5 from 2,000+ reviews</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div className="absolute top-20 left-20 text-4xl animate-bounce delay-500">✨</div>
  <div className="absolute top-32 right-32 text-3xl animate-bounce delay-1000">💫</div>
  <div className="absolute bottom-20 left-32 text-3xl animate-bounce delay-1500">🌟</div>
  ...
  <div className="container mx-auto px-4 md:px-6 relative">
    ...
    <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto">
      {USE_CASES.map(({ title, description, emoji, color }, index) => (
        ...
        >
          ...
          <Card className={`relative h-full hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 border-2 ${color} group-hover:border-opacity-80 overflow-hidden backdrop-blur-sm`}>
            {/* Card shine effect */}
    ...
    <div className="text-center mt-20 animate-in fade-in duration-1000 delay-1000">
      ...
      <section id="features" className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              Everything you need in <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">one place</span>
            </h2>
            <p className="mx-auto max-w-[700px] text-slate-600 text-xl leading-relaxed">
              From basic splitting to advanced analytics, we've got every scenario covered.
            </p>
          </div>
            ...
            {FEATURES.map(({ title, Icon, bg, color, description }, index) => (
              ...
              >
                <CardContent className="p-8 text-center space-y-6">
                  <div className={`mx-auto w-20 h-20 rounded-2xl ${bg} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
      ...
      <section id="how-it-works" className="py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <Badge variant="outline" className="bg-orange-50 text-orange-700 border-orange-200 mb-6">
              <Award className="w-4 h-4 mr-2" />
              How It Works
            </Badge>
            <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              Get started in <span className="bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">3 simple steps</span>
            </h2>
            <p className="mx-auto max-w-[700px] text-slate-600 text-xl leading-relaxed">
              From setup to settlement, everything is designed to be intuitive and fast.
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <div className="mb-16">
            <Badge variant="outline" className="bg-indigo-50 text-indigo-700 border-indigo-200 mb-6">
              <Globe className="w-4 h-4 mr-2" />
              Integrations
            </Badge>
            <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              Works with your <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">favorite apps</span>
            </h2>
            <p className="mx-auto max-w-[700px] text-slate-600 text-xl leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 max-w-4xl mx-auto">
            {INTEGRATIONS.map(({ name, logo }, index) => (
              ...
              >
                ...
                <span className="font-semibold text-slate-700 text-lg">{name}</span>
              </div>
            ))}
          </div>
        </div>
  ...
  <div className="container mx-auto px-4 md:px-6">
    ...
    {/* Cleaner pricing cards with consistent spacing */}
    <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
      {PRICING_TIERS.map((tier, index) => (
        <Card 
          ...
          style={{ animationDelay: `${index * 100}ms` }}
        >
          {/* Popular badge - cleaner positioning */}
          {tier.popular && (
          ...
          <div className={`p-8 ${tier.popular ? 'pt-16' : 'pt-8'} space-y-6`}>
            {/* Plan name and price - clean layout */}
            ...
            {/* CTA button - consistent positioning */}
    ...
    <div className="text-center mt-16 space-y-6">
      ...
      <section className="bg-white py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-200 mb-6">
              <Star className="w-4 h-4 mr-2" />
              Customer Love
            </Badge>
            <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              Loved by <span className="bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">thousands</span> worldwide
            </h2>
            <p className="mx-auto max-w-[700px] text-slate-600 text-xl leading-relaxed">
              See what our amazing community has to say about their Splitr experience.
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              Got <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">questions?</span>
            </h2>
            <p className="text-slate-600 text-xl leading-relaxed">
              Everything you need to know about Splitr. Can't find what you're looking for? 
              <Link href="/contact" className="text-emerald-600 hover:underline font-semibold ml-2">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-2xl text-blue-100 leading-relaxed max-w-3xl mx-auto">
                Join over 50,000 users who have simplified their shared expenses. 
                <br />
                <span className="font-bold text-white">Start free today, upgrade when you're ready.</span>
              </p>
            </div>
            ...
            <div className="pt-8 space-y-6">
              <p className="text-blue-100 text-lg">
                ✨ No credit card required • ⚡ Setup in under 30 seconds • 🔒 Bank-level security
              </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-5">
            <div className="lg:col-span-2 space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-lg leading-relaxed max-w-md">
                  The smartest way to split expenses with friends. Track, split, and settle up with complete ease.
                </p>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-400 to-blue-500 border-2 border-slate-900"></div>
                  ))}
                </div>
                <div>
                  <p className="font-semibold text-white">Trusted by 50,000+ users</p>
                  <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map((i) => (
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {['Features', 'Pricing', 'Security', 'API', 'Integrations'].map((item) => (
                  <li key={item}>
                    <Link href={`/${item.toLowerCase()}`} className="hover:text-emerald-400 transition-colors duration-300 text-lg">
                      {item}
                    </Link>
                  </li>
                ))}
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {['Help Center', 'Community', 'Status', 'Privacy Policy', 'Terms of Service'].map((item) => (
                  <li key={item}>
                    <Link href={`/${item.toLowerCase().replace(' ', '-')}`} className="hover:text-emerald-400 transition-colors duration-300 text-lg">
                      {item}
                    </Link>
                  </li>
                ))}
          ...
          <div className="border-t border-slate-800 py-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
              <p className="text-slate-400">
                © {new Date().getFullYear()} Splitr. All rights reserved. Made with ❤️ for better friendships.
              </p>
